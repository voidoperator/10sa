...
const ItemTemplate = React.memo((props: ItemTemplateProps) => {
  ...
  const getClassName: () => string = useCallback(() => {
    ...
    return `whitespace-nowrap w-1/2 md:w-1/3 lg:w-auto transition-all duration-300 hover:bg-gray-100 hover:bg-white/10 p-2 rounded cursor-pointer ${textColor} ${textColorHover}`;
  }, [primaryColor]);
...
const Shortcuts: React.FC = () => {
  ...
  return shortcutOptions?.length ? (
    <div className='md:border-b mb-3 lg:mb-0 lg:border-r lg:border-b-0 pr-1'>
